	...
	<div class="row">
	  <div class="col-md-12">
		<div class="card card-primary">
		  ...
		  <form role="form" id="quickForm" method="POST" action="{{ route('admin.doctor.exercise.update') }}" enctype="multipart/form-data">
			@csrf
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						...
						<select class="select2 category_id @error('category_id') is-invalid @enderror" name="category_id[]" id="category_id" multiple="multiple" data-placeholder="Select a Category" style="width: 100%;" disabled>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select class="select2 subcategory_id @error('subcategory_id') is-invalid @enderror" name="subcategory_id[]" id="subcategory_id" multiple="multiple" data-placeholder="Select a Subcategory" style="width: 100%;" disabled>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select id="exercise_id" class="exercise_id form-control" name="exercise_id" readonly>
								<option value="" selected>Select Exercise</option>
								@foreach($exercises as $k => $val)
									<option value="{{ $k }}" {{ old('exercise_id', $k == $data->exercise_id ? 'selected' : '') }}>
										{{ $val }}
									</option>
								@endforeach
							</select>
					...
					<div class="col-md-6">        
						<div class="form-group">
							<label for="name">Upload Featue Image
...
@section('pagejs')
	...
	<script>
		...
		document.querySelector("#quickForm").addEventListener("submit", function () {
