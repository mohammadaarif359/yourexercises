  ...
  <div class="row">
	<div class="col-12">
	  <div class="card">
		...
		<form role="form" id="quickForm" method="POST" action="{{ route('admin.doctor.exercise.attachment.store') }}" enctype="multipart/form-data">
		    @csrf
			<div class="card-body">
			  <div class="row">
...
$(function () {
	var table = $('#example1').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('admin.doctor.exercise.attachment',['exercise_id'=> $exercise_id]) }}",
        columns: [
