	...
	<div class="row">
	  <div class="col-md-12">
		<div class="card card-primary">
		  ...
		  <form role="form" id="frm-plan-submit" method="POST" action="{{ route('admin.doctor.plan.update') }}" enctype="multipart/form-data">
			@csrf
...
@section('pagejs')
	...
	<script>
		var totalcount = {{ count($data['doctor_plan_detail']) > 0 ? count($data['doctor_plan_detail']) - 1 : 0  }};
		var planDetail = @json($data['doctor_plan_detail']);
		...
		$("#btn-plan-submit").click(function (e) {
			...
			$.ajax({
				type: 'POST',
				url: "{{ route('admin.doctor.plan.update') }}",
