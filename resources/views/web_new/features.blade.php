                    ...
                    <a href="{{ url('feature/deatils') }}">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text px-lext-lim">Some quick example text to build on the card title and make up the bulk of the card's content. Some quick example text to build on the card title and make up the bulk of the card's content</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="top-bottom">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text px-lext-lim">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="" class="ps-read-more-btn">Read more</a>
                        </div>
                    </div>
                </div>
