<footer class="text-center text-lg-start text-white" style="background-color: #2c2e31">
    <!-- Section: Social media -->
    <section class="d-flex justify-content-between p-4 container flex-wrap" style="background-color: #1f2126">
      <!-- Left -->
      <div class="me-5">
      ...
      <div class="container text-center text-md-start mt-5">
        ...
        <div class="row mt-3 flex-wrap">
          ...
          <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4 text-left">
            ...
            <p class="m-1"><i class="fas fa-envelope mr-3"></i> info@example.com</p>
...
<script>
    ...
    const testimonials = [
    {
        text: "Since Covid, I transitioned to a practice that has no staff. At first, I was worried if I could handle running a busy office.",
        author: "Jason, Chiropractor",
        img: "https://storage.googleapis.com/a1aa/image/OiCEtdmdirrhIJSeIAiOVmkUgi39fUzx1recrHH0HxCmrS8nA.jpg"
    },
    {
        text: "The software has streamlined our operations and made it easier to manage patient records. It's a game-changer for our practice.",
        author: "Emily, Dentist",
        img: "https://storage.googleapis.com/a1aa/image/OiCEtdmdirrhIJSeIAiOVmkUgi39fUzx1recrHH0HxCmrS8nA.jpg"
    },
    {
        text: "I love how intuitive and user-friendly the platform is. It has significantly reduced the administrative burden on our staff.",
        author: "Michael, General Practitioner",
        img: "https://storage.googleapis.com/a1aa/image/OiCEtdmdirrhIJSeIAiOVmkUgi39fUzx1recrHH0HxCmrS8nA.jpg"
    }
    ];
    ...
    const testimonialText = document.getElementById('testimonial-text-cg');
