...
<div class="main-section">
    <div class="mt-3">
        <div class="container">
                <h2 class="section-title">Our Team Leadership</h2>
        </div>
            <div class="team-container ps-team-dr d-block pb-5">
                ...
                <div class="d-flex align-items-center flex-wrap justify-content-center">
                    ...
                    @php $profile_photo = $data->user['profile_photo_url'] ? $data->user['profile_photo_url'] : 'https://png.pngtree.com/png-vector/20230928/ourmid/pngtree-young-afro-professional-doctor-png-image_10148632.png'; @endphp
                    <a href="{{ url('/clinic/',$data['slug']) }}">
                        <div class="team-member my-2">
                            <img src="{{ $profile_photo }}"
                                alt="{{ $data['clinic_name'] }}">
                            <h3>{{ $data['user']['name'] }}</h3>
                            <h5><i class="fas fa-hospital me-1"></i> {{ $data['clinic_name'] }}</h5>
                            <div class="d-flex justify-content-between flex-wrap px-2">
                                <p>{{ $data['professional_info']['specialization'] ?? '' }}</p>
                                <p><i class="fas fa-star mr-1"></i>$data['avg_rating'] ?? 0</p>
                            </div>
                        </div>
                    </a>
                    @endforeach
